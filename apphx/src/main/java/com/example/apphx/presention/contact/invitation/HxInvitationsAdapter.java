...
public class HxInvitationsAdapter extends BaseAdapter {
    ...
    private class ViewHolder implements View.OnClickListener {
        ...
        private void updateView() {
            ...
            EaseUserUtils.setUserNick(inviteMessage.getFormId(), tvUsername);
            EaseUserUtils.setUserAvatar(ivAvatar.getContext(), inviteMessage.getFormId(), ivAvatar);
        }
    }
